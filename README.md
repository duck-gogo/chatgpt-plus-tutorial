...
<p align="center">本教程最新更新时间：2026 年 9 月 14 日 · 本次仅更新 Pro 20× 新开通与续订范围、流程</p>
...
> **9 月 14 日购买提醒：** OpenAI 自 9 月 10 日起暂停 Pro 20× 常规新订阅与升级，有效老用户仍可续费，Pro 5× 不受此次暂停影响。PlusGO 当前另有“新用户开通”和“存量会员续订”，不代表官方新购恢复；账号范围、覆盖周期与限制见 [Pro 仓库的新开通与续订指南](https://github.com/duck-gogo/chatgpt-pro-tutorial/blob/main/articles/pro-20x-pause-and-renewal.md)。

每天用 ChatGPT 或 Codex 做项目，我会先比较套餐的使用空间，再选付款方式。轻量写作、问答可以看 Plus；已经明确需要持续运行复杂任务，可以比较 Pro 5× 与符合条件的 20× 新开通；已有有效 20× 则重点确认续订。官方与第三方的购买范围分开看，由公司付款的还要提前确认账号安排、报价和凭证要求。
...
| Pro 5× 已反复在重置前耗尽，接下来仍有密集工作 | 分清限额类型，比较 20× 新开通完整成本与补量选项 | 官方常规升级仍暂停；PlusGO 新开通另核对账号、覆盖与购买限制，不默认补差或额度重置 |
| 已有有效 Pro 20×，准备继续使用 | 到期前安排续订 | 取消／降级生效后官方常规入口不能买回，第三方也不保证未来可购 |
...
|---|---|---|
| 官方美元月价 | $100 / 月 | $200 / 月 |
| 官方常规购买状态 | 新订阅、升级和续费不受此次暂停影响 | 暂停新订阅与升级；现有有效订阅可续费 |
| PlusGO 当前商品 | 新购／覆盖 | 新用户开通与存量会员续订分开，按当前账号状态选择 |
...
我会在付款前记录当前套餐、剩余用量、重置时间和接下来的任务。5× 开通、20× 新开通与存量续订及对应报价入口统一见 [ChatGPT Pro 充值教程](https://github.com/duck-gogo/chatgpt-pro-tutorial)；第三方当前流程可核对 [PlusGO 的 Pro 20× 新开通与续订公告](https://plusgo.pro/blog/chatgpt-pro-20x-renewal-notice/?utm_source=github01&utm_medium=readme&utm_campaign=pro_202609)。

> **已有订阅先看换档影响：** [官方常规入口仍暂停 20× 新购／升级](https://help.openai.com/en/articles/9793128-about-chatgpt-pro-plans)。PlusGO 的 20× 新开通接受当前 Free、Go、Plus 或 Pro 5× 且可正常登录 ChatGPT 网页的账号，从充值完成日起算 1 个月，不叠加剩余时间，不是官方补差升级；到期不自动续费，也不保证后续可再次订阅，退款限制需在购买前确认。有效 20× 存量续订则保留剩余时间，在到期扣费成功后接续 1 个月。Pro 5× 覆盖同样不叠加原剩余时间；Codex 额度不保证全量重置，以账号显示为准。
...
- **各自账号使用**：按成员需求比较 Plus、Pro 5×；考虑 PlusGO 的 20× 新开通时，逐个核对账号、覆盖与购买限制，与有效 20× 的续订需求分列询价，批量范围咨询时确认。
...
2. 选择适合自己的套餐。PlusGO 的 Pro 20× 分“新用户开通”（当前 Free / Go / Plus / Pro 5× 且可正常网页登录，先读覆盖与购买限制）和“存量会员续订”（按页面先核验再付款）；仍显示 20× 但状态异常，先联系客服。
3. 用支付宝或微信付款。
4. 回到原订单，按提示核对账号并明确确认提交；20× 新开通在付款后提交目标账号 Session，存量续订核对刚核验的同一账号。覆盖充值的剩余时间影响应提前读清，不要等后续再找二次覆盖按钮。临时会话凭证虽然不是密码，仍可能允许访问账号，需评估第三方的账号安全与条款风险。
5. 等待原订单结果并核对套餐与有效期。20× 新开通按充值完成日起算 1 个月；存量续订的“续订安排已完成”不代表到期日立即延长，需在到期自动扣费成功后再验收新周期。长时间没变化时凭订单号联系售后，不重复购买。
...
**想保留 Pro 20× 原续订资格，不要等变成 Free 后再买。** 官方常规新购仍暂停，仍有效时先确认原渠道安排；PlusGO 当前虽另有新开通方案，但不是恢复旧资格，也不保证后续可购。新开通到期不自动续费，存量续订则另按扣费安排验收，详见 [20× 新开通与续订指南](https://github.com/duck-gogo/chatgpt-pro-tutorial/blob/main/articles/pro-20x-pause-and-renewal.md)。
...
不一定。Plus 已包含 Work / Codex 中的 Astra；普通 Chat 的 GPT-6 Pro 则包含在 Pro 及符合条件的组织方案，不包含在 Plus。需要普通 Chat 的 Pro 模型或更多 Work / Codex 用量时，可比较 Pro 两档，并分清官方常规 20× 新购暂停与 PlusGO 的新开通条件。订阅正常但缺入口时，先检查客户端与权限。详见 [Astra 入口与限额](./articles/gpt-6-astra-which-plan.md)。
...
**近期变化：** 官方常规入口仍暂停 20× 新购与升级；PlusGO 当前的新开通属于另行确认条件的覆盖商品，不是官方补差升级，也不保证用量全量重置，详见 [Pro 购买范围](#pro)。9 月 9 日进入 Work / Codex 的 Deep Research 使用既有 Work / Codex 用量或点数，不额外送一套额度，普通 Chat 的 Deep Research 限额不变。[官方更新记录](https://help.openai.com/en/articles/6825453-chatgpt-release-notes)。
